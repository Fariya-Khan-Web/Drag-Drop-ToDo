...
const Navbar = () => {
    const { user, loading, dark, setDark, setLoading, logOut } = useContext(AuthContext)
    ...
    return (
        <div className='border-b border-[#322d29]/40 dark:border-[#d6d1cd]/30 dark:bg-[#1d1b1b]'>
            <div className="navbar max-w-screen-2xl w-[94%] mx-auto">

                <div className="flex-1">
                    <i className=" text-3xl font-bold">ListIt !</i>
                </div>
